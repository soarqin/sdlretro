    ...
    for (const auto &core_dir: core_dirs) {
        ...
        if (hFile!=INVALID_HANDLE_VALUE) {
            do {
                ...
                core_info coreinfo = {filename, info.library_name ? info.library_name : filename, info.library_version ? info.library_version : "unknown"};
        ...
        while ((ent = readdir(d)) != nullptr) {
            ...
            core_info coreinfo = {path, info.library_name ? info.library_name : path, info.library_version ? info.library_version : "unknown"};
            coreinfo.need_fullpath = info.need_fullpath;
            std::string exts = info.valid_extensions ? info.valid_extensions : "";
